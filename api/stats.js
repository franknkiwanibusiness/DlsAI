 ...
 *
 * Required env vars: FIREBASE_PROJECT_ID, FIREBASE_DATABASE_URL,
...
module.exports = async function handler(req, res) {
  ...
  // Deterministic daily-growth numbers the frontend renders as a/b/c.
  // Grows by a fixed daily delta — no scheduled job needed.
  ...
  const a = Math.floor(12 + daysSince * 0.04);  // e.g. "46k+ sellers"
  const b = Math.floor(8  + daysSince * 0.03);  // e.g. "35k+ sites listed"
  const c = Math.floor(40 + daysSince * 0.02);  // e.g. "71+ countries"
