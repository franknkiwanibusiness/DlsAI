...
//   VAPID_PRIVATE_KEY = (your secret — stored as VAPID_API_KEY in Vercel)
...
webpush.setVapidDetails(
  ...
  process.env.VAPID_API_KEY     // your private VAPID key from Vercel env
);
...
export default async function handler(req, res) {
  ...
  const payload = JSON.stringify({ title: title || 'Minimisty', body: body || '', url: url || '/admin', tag: tag || 'minimisty' });
